...
const bookAppointment = async (req, res) => {
    try {
        ...
        //checking for required slot if available
        ...
        const userData = await userModel.findById(userId).select("-password")
        //deleting slotsbooked as we want to save docData in appointment Db so avoid unnecessary data
        ...
        //save new updated appointments in docData
