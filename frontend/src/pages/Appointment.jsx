...
const Appointment = () => {
  ...
  const getAvailableSlot= async ()=>{
     ...
     let today = new Date();
     for(let i = 0; i<7; i++){
      //date with index (7 days time frame)
    ...
    <div>
      ...
      <div className='flex flex-col sm:flex-row gap-4'>
        ...
        <div className='flex-1 border border-gray-400 rounded-lg p-8 py-7 bg-white mx-2 sm:mx-0 mt-[-80px] sm:mt-0'>
          ...
          <p className='text-gray-500 font-medium mt-4'>Appoitment fee: <span className='text-gray-600'>{currencySymbol}{docInfo.fee}</span></p>
        </div>
      </div>
